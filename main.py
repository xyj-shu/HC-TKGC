...
if __name__ == '__main__':
    ...
    parser.add_argument("--description", type=str, default='yago_hard', help="your_description_for_folder_name")
    ...
    parser.add_argument("--oracle_mode", type=str, default='hard', help="soft and hard mode for Oracle")
    ...
    # 自定义参数列表
    # args_main.model_dir = 'yago_hard29-11-2023,08-04-07YAGO-EPOCH30'
    # args_main.only_eva = True
